      ...
      <main>
        <section className="border-b border-borde bg-superficie">
          <div className="mx-auto grid max-w-6xl items-center gap-14 px-5 py-16 sm:px-8 sm:py-20 md:grid-cols-2">
            <div>
              <p className="text-[11px] uppercase tracking-[0.3em] text-primario">Para compradores</p>
              <h1 className="mt-4 font-serif text-4xl font-medium leading-[1.1] text-texto sm:text-5xl">
                Enterate a tiempo de nuevas oportunidades.
              </h1>
              <p className="mt-5 max-w-md leading-relaxed text-texto-sec">
