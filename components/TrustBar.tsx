        ...
        <div className="mx-auto flex max-w-6xl flex-col gap-8 px-5 py-14 sm:px-8 md:flex-row md:items-center md:justify-between md:gap-12">
          <div className="flex items-baseline gap-4">
            <Counter
              to={30}
              suffix="+"
              className="font-serif text-7xl font-medium leading-none text-primario sm:text-8xl"
            />
            <p className="max-w-[16ch] text-sm uppercase tracking-[0.18em] text-texto-sec">
              años de MBEEF en el mercado de la carne
            </p>
          </div>

          <div className="hidden h-16 w-px bg-fondo md:block" aria-hidden="true" />

          <div className="space-y-1.5">
            <p className="font-serif text-2xl font-medium">
              MBEEF · Carne argentina · Desde 1994
            </p>
