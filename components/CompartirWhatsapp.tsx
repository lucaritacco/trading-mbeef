...
export default function CompartirWhatsapp({
  ...
  return (
    <a
      ...
      className={`inline-flex items-center justify-center gap-2 border border-verde-claro/40 px-5 py-2.5 text-sm text-verde-claro transition-colors hover:bg-verde/20 ${full ? "w-full" : ""}`}
    >
