    ...
    <section className="bg-carbon py-24 sm:py-32">
      <div className="mx-auto grid max-w-6xl items-center gap-12 px-5 sm:px-8 md:grid-cols-2 md:gap-16">
        <Reveal className="relative aspect-[4/3] overflow-hidden">
          {/* Foto provisional: reemplazar por fotografía propia de planta o hacienda (ver public/images/LEEME.md) */}
          <Image
        ...
        <Reveal delay={0.15}>
          ...
          <p className="mt-6 leading-relaxed text-taupe">
            MBEEF es un frigorífico argentino en actividad desde 1994, con
            planta propia en Adolfo Gonzales Chaves, provincia de Buenos Aires,
            y más de 30 años operando carne vacuna de selección.
          </p>
          ...
          <p className="mt-4 border border-dashed border-taupe/40 p-4 text-sm leading-relaxed text-taupe/70">
            ...
            del frigorífico antes de publicar la página]
          </p>
          <a
            href={site.mbeefUrl}
